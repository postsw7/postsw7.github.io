...
export const FS: Directory = {
  ...
  profile: {
    'about.md': `# Siwoo Lee\nToronto-based Software Engineer. I build practical systems with clear constraints and fast feedback.\n\n## Quick Start\nType 'help' for available commands.\nTry 'show recruiter' to see a short card.\nRun 'run demo jgrep' to try the JSON-friendly grep demo.\n\n## About\nI care about clarity, observability, explicit constraints, and repeatable outcomes.\nIf you want the deeper story, check 'experience.md' or 'skills.md'.`,
